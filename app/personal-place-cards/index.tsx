...
import { clearHeaderRightAction, headerAddAction } from '@/components/ui/header-actions';
    ...
    <>
      ...
      {isLoadingSession ? <LoadingView /> : !session ? (
        ...
        <ScrollView
          ...
          {refreshMessage ? <AppText color={Palette.textMuted}>{refreshMessage}</AppText> : null}
