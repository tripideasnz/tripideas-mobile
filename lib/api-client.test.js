...
assert.equal(
  normalizeApiBaseUrl('https://tripideas-api-staging.up.railway.app/'),
  'https://tripideas-api-staging.up.railway.app'
);
assert.equal(
  normalizeApiBaseUrl('https://tripideas-api-staging.up.railway.app///'),
  'https://tripideas-api-staging.up.railway.app'
  ...
  try {
...

    {
      ...
      await assert.rejects(
        authenticatedApiFetch('/itinerary', { method: 'POST' }),
        (error) =>
          error instanceof ApiError &&
          error.details?.requestPath === '/itinerary'
      );
    }
