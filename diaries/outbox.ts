...
export type DiaryMutationKind = 'create_diary' | 'update_diary' | 'delete_diary' | 'ensure_day' | 'update_day' | 'delete_day' | 'create_topic' | 'update_topic' | 'delete_topic' | 'reorder_topics' | 'create_object' | 'update_object' | 'delete_object' | 'reorder_objects';
...
const kinds = new Set<DiaryMutationKind>(['create_diary', 'update_diary', 'delete_diary', 'ensure_day', 'update_day', 'delete_day', 'create_topic', 'update_topic', 'delete_topic', 'reorder_topics', 'create_object', 'update_object', 'delete_object', 'reorder_objects']);
